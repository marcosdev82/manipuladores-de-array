...
// 9. Usando `reduceRight`, junte os elementos do array de trás para frente em uma string
// const letras = ["a", "b", "c"];
...
// 8. Usando `reduceRight`, junte os elementos do array de trás para frente em outro array
const letras = ["a", "b", "c"];
...
const reverseUnionArr = letras.reduceRight((acc, char) => {
    return acc.concat(char)
}, [])
console.log(reverseUnionArr)
